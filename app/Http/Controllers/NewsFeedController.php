...
class NewsFeedController extends Controller {
    ...
    {
        return view('news-feeds.manage-news-feed');
    }
...
//    }
    ...
    {
        return view('news-feeds.add-news-feed');
    }
    ...
    public function edit(Request $request) {
        ...
        return view('news-feeds.edit-news-feed')->with('news_feed', $news_feed);
    ...
    public function showAllNewsFeeds() {
        ...
        return view('news-feeds.view-news-feed')->with('news_feeds', $news_feeds);
    }
    ...
    public function getImagesForNewsFeed(Request $request) {
        ...
        return view('news-feeds.news-feed-images')
