...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="/admin/insiders">Insiders</a></li>
    <li class="breadcrumb-item active" aria-current="page">Manage</li>
@endsection

@section('actions')
    <a href="/admin/insiders/create" class="btn btn-sm btn-neutral">New</a>
@endsection
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="insiders-list">
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Delete Insiders</h6>
...
@section ('custom-script')
    ...
    <script>
        let manageInsidersTable = $('#insiders-list');

        manageInsidersTable.DataTable({
            processing: true,
            serverSide: true,
            ajax: '/admin/insiders/get-insiders',
            columns: [
                {data: 'name', name: 'name'},
        ...
        manageInsidersTable.on('click', '.edit', function () {
            $id = $(this).attr('id');
            window.location.pathname = '/admin/insiders/' + $id + '/edit';
        });
